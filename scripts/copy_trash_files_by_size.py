...
def main():
    ...
    # 3. Match
    commands_file = "logs/rclone_copy_trash_matched.txt"
    output_script = "scripts/run_copy_trash.sh"
    matched_count = 0
    missing_files = []
    ...
    if missing_files:
        with open("logs/missing_files_trash_size_match.txt", "w", encoding="utf-8") as f:
